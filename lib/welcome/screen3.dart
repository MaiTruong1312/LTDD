...
class SplashScreen3 extends StatelessWidget {
  ...
  const SplashScreen3({super.key, required this.onNext, required this.onSkip});
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Image.asset(
                    'assets/images/mockup_screen_3.png', // Thay bằng ảnh của bạn
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  // Mô tả
                  const Text(
                    'Unlock exclusive perks, earn points easily, and immerse yourself in a personalized beauty world. Welcome to Pionails!',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.grey,
                      fontSize: 16,
